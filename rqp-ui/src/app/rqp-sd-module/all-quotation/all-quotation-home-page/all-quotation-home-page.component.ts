...
@Component({
  selector: 'app-all-quotation-home-page',
  templateUrl: './all-quotation-home-page.component.html',
  styleUrls: ['./all-quotation-home-page.component.scss'],
})
export class AllQuotationHomePageComponent
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  onReviewerData() {
    ...
    this.getReviewDataAPICall = this.sdService
      .getAllAssignmentData(
        this.headerRequestBody.lifeCycleCode,
  ...
  onSubmit() {
    ...
    this.router.navigate(['./sd/all-quotation-print-page'], { queryParams: this.selectedRow });
  }
  copyData() {
    var dataArray = '';
    let tableData: any;
