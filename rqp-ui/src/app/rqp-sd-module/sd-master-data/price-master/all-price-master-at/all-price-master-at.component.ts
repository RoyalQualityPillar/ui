...
@Component({
  selector: 'app-all-price-master-at',
  templateUrl: './all-price-master-at.component.html',
  styleUrls: ['./all-price-master-at.component.scss']
})
export class AllPriceMasterAtComponent implements OnInit{
  @ViewChild('htmlData') htmlData!: ElementRef;

  constructor(public adminService:AdminService,
    private saleProductMasterService: PriceMasterService,
    public messageService:MessageService,
    public dialogRef: MatDialogRef<AllPriceMasterAtComponent>,
