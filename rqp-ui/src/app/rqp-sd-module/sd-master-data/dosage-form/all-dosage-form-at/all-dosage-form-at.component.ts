...
@Component({
  selector: 'app-all-dosage-form-at',
  templateUrl: './all-dosage-form-at.component.html',
  styleUrls: ['./all-dosage-form-at.component.scss']
})
export class AllDosageFormAtComponent implements OnInit{
  @ViewChild('htmlData') htmlData!: ElementRef;

  constructor(public adminService:AdminService,
    private saleProductMasterService: DosageFormService,
    public messageService:MessageService,
    public dialogRef: MatDialogRef<AllDosageFormAtComponent>,
