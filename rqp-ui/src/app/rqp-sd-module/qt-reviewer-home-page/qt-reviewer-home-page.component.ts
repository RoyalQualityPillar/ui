...
@Component({
  selector: 'app-qt-reviewer-home-page',
  templateUrl: './qt-reviewer-home-page.component.html',
  styleUrls: ['./qt-reviewer-home-page.component.scss'],
})
export class QtReviewerHomePageComponent
