...
@Component({
  selector: 'app-dq-review-home-page',
  templateUrl: './dq-review-home-page.component.html',
  styleUrls: ['./dq-review-home-page.component.scss']
})
export class DqReviewHomePageComponent  implements OnInit, AfterViewInit, OnDestroy
{
