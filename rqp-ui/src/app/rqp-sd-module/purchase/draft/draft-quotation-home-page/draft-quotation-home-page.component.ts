...
@Component({
  selector: 'app-draft-quotation-home-page',
  templateUrl: './draft-quotation-home-page.component.html',
  styleUrls: ['./draft-quotation-home-page.component.scss'],
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
  ],
})
export class DraftQuotationHomePageComponent implements OnInit{
