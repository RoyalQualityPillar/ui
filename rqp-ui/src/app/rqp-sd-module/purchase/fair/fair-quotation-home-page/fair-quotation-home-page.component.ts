...
@Component({
  selector: 'app-fair-quotation-home-page',
  templateUrl: './fair-quotation-home-page.component.html',
  styleUrls: ['./fair-quotation-home-page.component.scss'],
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
  ],
})
export class FairQuotationHomePageComponent implements OnInit{
  ...
  onSaveUpdate(btnStatus:any){
    ...
    this.isLoading=true;
    this.fairService.onSaveUpdateDQ(requestBody).subscribe((data:any)=>{
     // console.log(data)
