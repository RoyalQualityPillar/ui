...
@Component({
  selector: 'app-fair-review-home-page',
  templateUrl: './fair-review-home-page.component.html',
  styleUrls: ['./fair-review-home-page.component.scss']
})
export class FairReviewHomePageComponent implements OnInit, AfterViewInit, OnDestroy
{
