...
{path:'admin',loadChildren:()=>import('./rqp-admin-module/admin/admin.module').then(m=>m.AdminModule)},
{path:'sd',loadChildren:()=>import('./rqp-sd-module/sd/sd.module').then(m=>m.SdModule)},
