...
@Component({
  selector: 'app-dq-initiator',
  templateUrl: './dq-initiator.component.html',
  styleUrls: ['./dq-initiator.component.scss']
})
export class DqInitiatorComponent implements OnInit {
  ...
  onSaveUpdate(btnStatus: any) {
    ...
    requestBody = {
      pmmdraftQuotationItemList: this.stockList,
      lcRequest: {
    ...
    this.isLoading = true;
    this.dqService.onSaveUpdate(requestBody).subscribe((data: any) => {
      // console.log(data)
