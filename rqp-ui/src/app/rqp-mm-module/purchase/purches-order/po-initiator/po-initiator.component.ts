...
@Component({
  selector: 'app-po-initiator',
  templateUrl: './po-initiator.component.html',
  styleUrls: ['./po-initiator.component.scss']
})
export class PoInitiatorComponent {
  ...
  onSaveUpdate(btnStatus: any) {
    ...
    requestBody =
    {
      ...
      collectiveNo: "",
      quotationRefNo: "",
      quotationRefDate: moment(this.QuotationForm.controls['quotationValidDate'].value).format('DD-MM-YYYY HH:mm:ss.SSS'),
      pmmpurchaseOrderItemList: this.stockList,
    ...
    this.isLoading = true;
    this.purchaseOrderService.onSaveUpdate(requestBody).subscribe((data: any) => {
      // console.log(data)
