...
@Component({
  selector: 'app-do-reviewer',
  templateUrl: './do-reviewer.component.html',
  styleUrls: ['./do-reviewer.component.scss']
})
export class DoReviewerComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  onSubmit() {
    ...
    this.router.navigate(['./mm/do-review-save'], { queryParams: this.selectedRow })
  }
  copyData() {
    var dataArray = "";
    let tableData: any;
  ...
  downloadExcel() {
    ...
    exportData(arrExcel, 'role', 'pdo', 'excel')
  }
  downloadTxt() {
    let excelData: any;
    let arrExcel = [];
    ...
    exportData(arrExcel, 'role', 'pdo', 'txt')
  }
  ...
  downloadCsvFile() {
    ...
    exportData(arrExcel, 'role', 'pdo', 'csv')
  }
