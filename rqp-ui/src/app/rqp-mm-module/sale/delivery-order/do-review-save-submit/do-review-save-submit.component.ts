...
@Component({
  selector: 'app-do-review-save-submit',
  templateUrl: './do-review-save-submit.component.html',
  styleUrls: ['./do-review-save-submit.component.scss']
})
export class DoReviewSaveSubmitComponent implements OnInit {
  ff0001: any;
  pageData: any;
  isReadonly: boolean;
