...
@Component({
  ...
  styleUrls: ['./so-initiator.component.scss']
})
export class SoInitiatorComponent implements OnInit {
  ...
  constructor(public fb: FormBuilder,
    ...
    private saleOrdereService: SalaOrderService,
  ...
  onSaveUpdate(btnStatus: any) {
    ...
    requestBody = {
      ...
      pmmsaleOrderItemList: this.stockList,
    ...
    this.isLoading = true;
    this.saleOrdereService.onSaveUpdate(requestBody).subscribe((data: any) => {
      // console.log(data)
