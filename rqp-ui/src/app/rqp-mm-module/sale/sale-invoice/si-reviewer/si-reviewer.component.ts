...
@Component({
  selector: 'app-si-reviewer',
  templateUrl: './si-reviewer.component.html',
  styleUrls: ['./si-reviewer.component.scss']
})
export class SiReviewerComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  onSubmit() {
    ...
    this.router.navigate(['./mm/si-review-save'], { queryParams: this.selectedRow })
  }
  copyData() {
    var dataArray = "";
    let tableData: any;
