...
@Component({
  selector: 'app-si-review-save-submit',
  templateUrl: './si-review-save-submit.component.html',
  styleUrls: ['./si-review-save-submit.component.scss']
})
export class SiReviewSaveSubmitComponent implements OnInit {
  ff0001: any;
  pageData: any;
  isReadonly: boolean;
