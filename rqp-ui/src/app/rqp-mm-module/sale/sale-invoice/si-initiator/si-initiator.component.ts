...
import { SalaInvoiceService } from '../sala-invoice.service';
...
@Component({
  selector: 'app-si-initiator',
  templateUrl: './si-initiator.component.html',
  styleUrls: ['./si-initiator.component.scss']
})
export class SiInitiatorComponent implements OnInit {
