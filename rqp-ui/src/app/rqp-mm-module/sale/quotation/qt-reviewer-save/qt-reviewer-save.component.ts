...
@Component({
  selector: 'app-qt-reviewer-save',
  templateUrl: './qt-reviewer-save.component.html',
  styleUrls: ['./qt-reviewer-save.component.scss']
})
export class QtReviewerSaveComponent {
  ...
  constructor(public router: ActivatedRoute, public sdService: SdService, public lifeCycleDataService: LifeCycleDataService,
    ...
    public messageService: MessageService, public quotationService: QuotationService) {
