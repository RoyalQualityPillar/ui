...
@Component({
  selector: 'app-all-payment-term-at',
  templateUrl: './all-payment-term-at.component.html',
  styleUrls: ['./all-payment-term-at.component.scss']
})
export class AllPaymentTermATComponent implements OnInit{
  @ViewChild('htmlData') htmlData!: ElementRef;

  constructor(public adminService:AdminService,
    private saleProductMasterService: PaymentTermService,
    public messageService:MessageService,
    public dialogRef: MatDialogRef<AllPaymentTermATComponent>,
