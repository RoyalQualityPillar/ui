...
@Component({
  selector: 'app-standard-reason-registartion-create-update',
  templateUrl: './standard-reason-registartion-create-update.component.html',
  styleUrls: ['./standard-reason-registartion-create-update.component.scss']
})
export class StandardReasonRegistartionCreateUpdateComponent implements OnInit  {
  isReadOnly=true;
  isUpdate=false;
  ...
  constructor(public fb: FormBuilder,
    ...
    public dialogRef: MatDialogRef<StandardReasonRegistartionCreateUpdateComponent>,
  ...
  onUpdate(){
    this.isLoading = true;
    this.standardReasonRegistartionService.onCreate(this.DepartmentMaster.value).subscribe((data: any) => {
