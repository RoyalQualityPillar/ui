...
@Component({
  selector: 'app-module-create-update',
...
export class ModuleCreateUpdateComponent implements OnInit  {
  ...
  constructor(public fb: FormBuilder,
    ...
    public dialogRef: MatDialogRef<ModuleCreateUpdateComponent>,
  ...
  onUpdate(){
    this.isLoading = true;
    this.moduleService.onCreate(this.DepartmentMaster.value).subscribe((data: any) => {
