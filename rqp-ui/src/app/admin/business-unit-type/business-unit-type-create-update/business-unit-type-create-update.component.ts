...
@Component({
  selector: 'app-business-unit-type-create-update',
  templateUrl: './business-unit-type-create-update.component.html',
  styleUrls: ['./business-unit-type-create-update.component.scss']
})
export class BusinessUnitTypeCreateUpdateComponent  implements OnInit  {
  isReadOnly=true;
  isUpdate=false;
  ...
  constructor(public fb: FormBuilder,
    ...
    public dialogRef: MatDialogRef<BusinessUnitTypeCreateUpdateComponent>,
  ...
  onUpdate(){
    this.isLoading = true;
    this.businessUnitTypeService.onCreate(this.DepartmentMaster.value).subscribe((data: any) => {
