...
@Component({
  selector: 'app-business-unit-type-home-page',
  templateUrl: './business-unit-type-home-page.component.html',
  styleUrls: ['./business-unit-type-home-page.component.scss']
})
export class BusinessUnitTypeHomePageComponent implements OnInit, AfterViewInit {
  ...
  constructor(private _liveAnnouncer: LiveAnnouncer,
    ...
    public businessUnitTypeService:BusinessUnitTypeService) {}
  ...
  applyFilterByColumn(){
    ...
    this.isLoading=true;
    this.businessUnitTypeService.getUserProfileFilterData(filetrDataBody).subscribe((data: any) => {
      console.log(data)
      if(data.data){
