...
@Component({
  selector: 'app-all-unit-master-audit-trail',
  templateUrl: './all-unit-master-audit-trail.component.html',
  styleUrls: ['./all-unit-master-audit-trail.component.scss']
})
export class AllUnitMasterAuditTrailComponent implements OnInit{
  @ViewChild('htmlData') htmlData!: ElementRef;

  constructor(public adminService:AdminService,
    private utMasterService: UtMasterService,
    public messageService:MessageService,
    public dialogRef: MatDialogRef<AllUnitMasterAuditTrailComponent>,
  ...
  onSearch(){
    this.isLoading=true;
    this.utMasterService.onAllRoleAuditTrail(this.userData.tableData.uc0001).subscribe((data: any) => {
      console.log(data);
      this.data=data.data;
