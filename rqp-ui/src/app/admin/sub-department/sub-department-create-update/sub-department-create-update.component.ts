...
@Component({
  selector: 'app-sub-department-create-update',
  templateUrl: './sub-department-create-update.component.html',
  styleUrls: ['./sub-department-create-update.component.scss']
})
export class SubDepartmentCreateUpdateComponent implements OnInit  {
  isReadOnly=true;
  isUpdate=false;
  ...
  constructor(public fb: FormBuilder,
    ...
    public dialogRef: MatDialogRef<SubDepartmentCreateUpdateComponent>,
  ...
  onUpdate(){
    this.isLoading = true;
    this.subDepartmentService.onCreate(this.DepartmentMaster.value).subscribe((data: any) => {
