...
@Component({
  ...
  templateUrl: './sub-department-home-page.component.html',
  styleUrls: ['./sub-department-home-page.component.scss']
})
export class SubDepartmentHomePageComponent implements OnInit, AfterViewInit {
  ...
  applyFilterByColumn(){
    ...
    this.isLoading=true;
    this.subDepartmentService.getUserProfileFilterData(filetrDataBody).subscribe((data: any) => {
      console.log(data)
      if(data.data){
  ...
  onActiveSelectRow(){
    if(this.selectedRow.length==0){
      ...
      const dialogRef=this.dialog.open(SubDepartmentCreateUpdateComponent,{
          minWidth:"80%",
