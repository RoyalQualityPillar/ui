...
@Component({
  ...
  templateUrl: './pack-master-home-page.component.html',
  styleUrls: ['./pack-master-home-page.component.scss']
})
export class PackMasterHomePageComponent implements OnInit, AfterViewInit {
  ...
  constructor(private _liveAnnouncer: LiveAnnouncer,
    ...
    public packMasterService:PackMasterService) {}
  ...
  applyFilterByColumn(){
    ...
    this.isLoading=true;
    this.packMasterService.getUserProfileFilterData(filetrDataBody).subscribe((data: any) => {
      console.log(data)
      if(data.data){
