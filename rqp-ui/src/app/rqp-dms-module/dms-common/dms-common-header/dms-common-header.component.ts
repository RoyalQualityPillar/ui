...
@Component({
  selector: 'app-dms-common-header',
  templateUrl: './dms-common-header.component.html',
  styleUrls: ['./dms-common-header.component.scss']
})
export class DmsCommonHeaderComponent implements OnInit{
 ...
 // @Output() requestNo = new EventEmitter<any>();
  ...
  this.dmsService.getHeaderData(body).subscribe((data:any)=>{
