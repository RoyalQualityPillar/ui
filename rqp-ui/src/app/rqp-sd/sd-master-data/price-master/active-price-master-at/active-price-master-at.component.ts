...
@Component({
  selector: 'app-active-price-master-at',
  templateUrl: './active-price-master-at.component.html',
  styleUrls: ['./active-price-master-at.component.scss']
})
export class ActivePriceMasterAtComponent implements OnInit{
  @ViewChild('htmlData') htmlData!: ElementRef;
  isLoading=false
  constructor(public adminService:AdminService,
    public dialog: MatDialog,
    private saleProductMasterService: PriceMasterService,
    public dialogRef: MatDialogRef<ActivePriceMasterAtComponent>,
