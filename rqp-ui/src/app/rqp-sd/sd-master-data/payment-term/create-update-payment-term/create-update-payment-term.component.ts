...
@Component({
  selector: 'app-create-update-payment-term',
  templateUrl: './create-update-payment-term.component.html',
  styleUrls: ['./create-update-payment-term.component.scss']
})
export class CreateUpdatePaymentTermComponent implements OnInit  {
  isReadOnly=true;
  isUpdate=false;
  ...
  constructor(public fb: FormBuilder,
    ...
    public dialogRef: MatDialogRef<CreateUpdatePaymentTermComponent>,
    @Inject(MAT_DIALOG_DATA) public userData: userData,
    private payementTermService:PaymentTermService,private businessUnitService:BusinessUnitService) {
