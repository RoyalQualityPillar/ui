...
@Component({
  selector: 'app-create-update-price-type',
  templateUrl: './create-update-price-type.component.html',
  styleUrls: ['./create-update-price-type.component.scss']
})
export class CreateUpdatePriceTypeComponent implements OnInit  {
  isReadOnly=true;
  isUpdate=false;
  ...
  constructor(public fb: FormBuilder,
    ...
    public dialogRef: MatDialogRef<CreateUpdatePriceTypeComponent>,
    @Inject(MAT_DIALOG_DATA) public userData: userData,
    private payementTermService:PriceTypeService,private businessUnitService:BusinessUnitService) {
