...
import { BusinessUnitService } from 'src/app/admin/business-unit/business-unit.service';
...
@Component({
  selector: 'app-create-update-numbering-system',
  templateUrl: './create-update-numbering-system.component.html',
  styleUrls: ['./create-update-numbering-system.component.scss']
})
export class CreateUpdateNumberingSystemComponent implements OnInit  {
  isReadOnly=true;
  isUpdate=false;
  ...
  constructor(public fb: FormBuilder,
    ...
    public dialogRef: MatDialogRef<CreateUpdateNumberingSystemComponent>,
    @Inject(MAT_DIALOG_DATA) public userData: userData,
    private payementTermService:NumberingSystemService,private businessUnitService:BusinessUnitService) {
