...
@Component({
  selector: 'app-all-sale-product-master-at',
  templateUrl: './all-sale-product-master-at.component.html',
  styleUrls: ['./all-sale-product-master-at.component.scss']
})
export class AllSaleProductMasterAtComponent implements OnInit{
  @ViewChild('htmlData') htmlData!: ElementRef;

  constructor(public adminService:AdminService,
    private saleProductMasterService: SaleProductMasterService,
    public messageService:MessageService,
    public dialogRef: MatDialogRef<AllSaleProductMasterAtComponent>,
